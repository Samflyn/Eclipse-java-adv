...
<body>
	<h3 style="text-align: center;">
		Success !<br> Your payment has been successfull <br> <br>
		Estimated Delivery date -
		<c:out value="${day}"></c:out>
		<br> <br> Payment Details : <br> <br> Transaction
		Id :
		<c:out value="${tx.txid}"></c:out>
		<br> <br> Date of purchase :
		<c:out value="${tx.date}"></c:out>
		<br> <br> Shipping Address :
		<c:out value="${tx.address}"></c:out>
		<br> <br> Items :
