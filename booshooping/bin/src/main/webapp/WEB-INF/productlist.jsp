...
<body>
	...
	<h1 style="text-align: end;">
		<input type="button" onclick="window.location.href='mycart';"
			value="My Cart">
	</h1>
		...
		<c:forEach items="${products}" var="product" varStatus="roll">
			<tr>
				...
				<td style="text-align: center;">
					<button id="minus${roll.count}" class="minus">-</button> <input
					type="text" id="quantity${roll.count}" value="0" size="1">
				...
				<td style="text-align: center;"><input type="button"
					value="Add to cart" id="tocart${roll.count}" class="tocart"></td>
			</tr>
		</c:forEach>
	</table>
	<br>
	...
	<h1 style="text-align: center;">
		<input type="button" onclick="window.location.href='address';"
			value="My Address">
	</h1>
	<br>
	<br>
