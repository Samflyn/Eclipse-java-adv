var app = angular.module('sailoApp', ['sailo']);
app.run(['$rootScope', '$state', '$stateParams', '$trace', '$localStorage',
	function ($rootScope, $state, $stateParams, $trace, $localStorage) {
		...
		$rootScope.$on('$stateChangeStart', function (event, toState, toParams, fromState, fromParams, options) {
			...
			if($localStorage.user) {
				...
				$rootScope.role = $rootScope.user.roleMasterDto.roleName;
			}
		...
		$rootScope.app = {
			name: 'messer-ap-automation-web', // name of your project
			author: 'Sailotech', // author's name or company name
			description: 'Messer AP Automation Web application', // brief description
