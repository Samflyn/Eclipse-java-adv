...
public class MailConnectionUtils {
	...
	/**
	 * Open new Connection Store with given properties with emailSession
	 * new session Store will not create If store is already exist and connected.  
	 * @return
	...
	/**
	 * Close the Store if exist and connected.
	 * If the connection is closed return <code>true</code> if already closed return <code>false</code> 
	 * @return
	 * @throws MessagingException
	 */
